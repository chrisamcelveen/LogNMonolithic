...
public class LogNMonolithicApp {

    private static final Logger log = LoggerFactory.getLogger(LogNMonolithicApp.class);

    private final Environment env;

    public LogNMonolithicApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes LogNMonolithic.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LogNMonolithicApp.class);
